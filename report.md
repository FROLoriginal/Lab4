...
subtitle: "Модель гармонических колебаний - вариант 36"
...
силы $\ddot{x}+6\dot{x}+12x=\cos{6t}$
...
![График решения для случая 1](image/p1c1.png){ #fig:001 width=70% height=70% }

![Фазовый портрет для случая 1](image/p1c2.png){ #fig:002 width=70% height=70% }
...
![График решения для случая 2](image/p2p3.png){ #fig:003 width=70% height=70% }

![Фазовый портрет для случая 2](image/p2c2.png){ #fig:004 width=70% height=70% }
...
```
![График решения для случая 3](image/p3p1.png){ #fig:005 width=70% height=70% }

![Фазовый портрет для случая 3](image/p3p2.png){ #fig:006 width=70% height=70% }
